	...
	$.validationEngineLanguage = {
		newLang: function() {
			$.validationEngineLanguage.allRules = 	{"required":{    			// Add your regex rules here, you can take telephone as an example
					"regex":"none",
						"alertText":"* Påkrevd felt",
						"alertTextCheckboxMultiple":"* Velg et alternativ",
						"alertTextCheckboxe":"* Påkrevd valg"},
					"length":{
						"regex":"none",
						"alertText":"* Mellom ",
						"alertText2":" og ",
						"alertText3": " tegn tillatt"},
					"maxCheckbox":{
						"regex":"none",
						"alertText":"* Antall merkinger oversteget"},	
					"minCheckbox":{
						"regex":"none",
						"alertText":"* Velg ",
						"alertText2":" valg"},	
					...
					"number":{
						...
						"regex": /^[\-\+]?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)$/,
						"alertText":"* Ikke et gyldig desimaltall"},
					"date":{
